...
func test_wall_left_bounces_right() -> void:
	var result: Array = BallScript.calc_wall_bounce(Vector2(5, 360), Vector2(-1, 0), RADIUS, Rect2(0, 0, 480, 720))
...
func test_wall_right_bounces_left() -> void:
	var result: Array = BallScript.calc_wall_bounce(Vector2(475, 360), Vector2(1, 0), RADIUS, Rect2(0, 0, 480, 720))
...
func test_wall_top_bounces_down() -> void:
	var result: Array = BallScript.calc_wall_bounce(Vector2(240, 3), Vector2(0, -1), RADIUS, Rect2(0, 0, 480, 720))
	assert_true(result[1].y > 0, "Should bounce down off top wall")


func test_wall_no_collision_keeps_velocity() -> void:
	var result: Array = BallScript.calc_wall_bounce(Vector2(240, 360), Vector2(1, 1), RADIUS, Rect2(0, 0, 480, 720))
